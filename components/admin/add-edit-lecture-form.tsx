...
export default function AddEditLectureForm({
  isOpen,
  onClose,
  lecture,
  onSuccess,
  ...
  const [category, setCategory] = useState<"Theoretical" | "Practical">(
    "Theoretical"
  );
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription className="font-inter text-base font-normal text-neutral-grey leading-relaxed">
            {lecture
              ? currentContent.auth.adminDashboard.contentManagement
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="title" className="text-right text-neutral-dark">
              {
                currentContent.auth.adminDashboard.contentManagement.form
                  .lectureTitle
              }
            </Label>
            <Input
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label
              htmlFor="description"
              className="text-right text-neutral-dark"
            >
              {
                currentContent.auth.adminDashboard.contentManagement.form
                  .description
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select
              value={category}
              onValueChange={(value) =>
                setCategory(value as "Theoretical" | "Practical")
              }
            >
