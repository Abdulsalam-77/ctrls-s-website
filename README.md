...
│  ├─ placeholder.svg
│  └─ why-ctrl-s
│     ├─ A Learning Community That Feels Like Family.png
│     ├─ A Roadmap You Can Trust without logo.PNG
│     ├─ An Early Path to Success.PNG
│     ├─ Soft Skills Build Their Future.PNG
│     └─ Thinkers, Not Just Coders without logo.PNG
├─ scripts
│  └─ supabase
│     └─ init.sql
├─ styles
